<h2><a href="https://www.geeksforgeeks.org/problems/eco-friendly-and-sugar-free-products/1?page=2&category=python&sortBy=submissions">Eco-Friendly and Low-Calorie Products</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><h3><span style="font-size: 14pt;">Problem Description:</span></h3>
