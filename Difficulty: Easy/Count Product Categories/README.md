<h2><a href="https://www.geeksforgeeks.org/problems/count-product-categories/1?page=2&category=python&sortBy=submissions">Count Product Categories</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><h2>Problem Description:</h2>
