<h2><a href="https://www.geeksforgeeks.org/problems/most-frequent-student-scores/1?page=2&category=python&sortBy=submissions">Most Frequent Student Scores</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><h2><span style="font-size: 14pt;">Problem Description:</span></h2>
...
<p><span style="font-size: 14pt;"><span style="font-size: 18.6667px;">The result is a <strong>DataFrame </strong>having <strong>score </strong>and <strong>mode</strong>.</span></span></p>
<ul>
<li><span style="font-size: 14pt;"> </span>
