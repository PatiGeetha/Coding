<h2><a href="https://www.geeksforgeeks.org/problems/salesperson-without-orders-to-company-blue/1?page=2&category=python&sortBy=submissions">Salesperson Without Orders to Company "BLUE</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><h3>Problem Description:</h3>
