<h2><a href="https://www.geeksforgeeks.org/problems/invalid-comments/1?page=2&category=python&sortBy=submissions">Invalid Comments</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><h3 class="" data-start="35" data-end="59">Problem Description:</h3>
